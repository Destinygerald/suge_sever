...
app.use(function(req, res, next) {
    ...
    const allowedOrigins = ['http://localhost:5173', 'https://suge.co.uk', 'http://suge.co.uk', 'https://suge-3a6v.onrender.com', 'http://suge.co.uk', 'http://sugeuk.com', 'https://sugeuk.com'];
